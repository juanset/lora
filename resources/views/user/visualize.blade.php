                            ...
                            awe.projections.add(
                                    {
                                        ...
                                        {
                                            shape: 'plane',
                                            height: parseInt("{{$scene["background_high"]}}"),
                                        ...
                                        texture:
                                        {
                                            ...
                                            path: "{{asset("realidad/fondos/".$scene["background_route"])}}"
                                        },
                                    },
                                    { poi_id: 'poi_1' });
                            ...
                            awe.projections.add(
                                    {
                                        ...
                                        geometry:
                                        {
                                            path: "{{asset("realidad/objetos/".$objects["object_route"])}}"

                                        },

                                        scale:
                                        {
                                            x: parseInt("{{$objects["scale_x"]}}"),
                                            y: parseInt("{{$objects["scale_y"]}}"),
                                        ...
                                        {
                                            //path: lista[0].value
                                            path: "{{asset("realidad/texturas/".$objects["texture_route"])}}"
                                        },
                                    },
                                    {poi_id: 'poi_1'});
